...
class TestLegacyManage(TestManageBase):
    ...
    @mock.patch.object(manage.DbCommands, 'data_migrate')
    def test_legacy_db_data_migrate(self, db_data_migrate):
        self._main_test_helper(['glance.cmd.manage', 'db_data_migrate'],
                               manage.DbCommands.data_migrate)
...
class TestManage(TestManageBase):
    ...
    @mock.patch.object(manage.DbCommands, 'data_migrate')
    def test_db_data_migrate(self, data_migrate):
        self._main_test_helper(['glance.cmd.manage', 'db', 'data_migrate'],
                               manage.DbCommands.data_migrate)
